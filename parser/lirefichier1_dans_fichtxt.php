...
function connexxion (){ 
	...
	connexxion ();
ini_set('max_execution_time', 600);// temps exécution phpmyadmin
...
echo "<br>";
 ...
 //ouvrir un nouveau fichier en ecriture pour stockerle fichier avant de l'importer dans la base
$fich2="./fich2";
 $nouv=fopen($fich2,'a');
$metabolite="";
$k=-1;	
